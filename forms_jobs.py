...
scheduler.add_job(timetable_manager.check_days, 'cron', hour=7, minute=0, second=0, args=(app, ))
scheduler.add_job(timetable_manager.update_daily_tasks, 'cron', hour=3, minute=1, second=0, args=(app, ))
scheduler.add_job(algorithm_manager.check_detach_dates, 'cron', hour=16, minute=18, second=0, args=(app, ))
