    ...
    <div>
        ...
        <div v-if="state == 'main'">
            ...
            <div v-if="parts.length == 0 || parts.includes('meds')">
                ...
                <small v-if="(!patient.patient_medicines || !patient.patient_medicines.length) && (!patient.patient_canceled_medicines || !patient.patient_canceled_medicines.length)">Нет добавленных
                    препаратов</small>
